...
class GroupSerializer(serializers.ModelSerializer):
    ...
    This serializer includes all fields of the Group model and serializes
    associated permissions using the PermissionSerializer. It also filters
    out non-empty fields from the representation.
    """
    ...
    def to_representation(self, instance: Group) -> Dict:
        """
        Customize the representation of the Group instance by filtering
        out non-empty fields.
